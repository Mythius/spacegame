...
| 5 | 2026-04-06 | Base rendering: procedural asteroid polygon + facets + craters + ore deposits rendered in build mode canvas. Star field background. Build system now drives from BUILDING_REGISTRY (palette, valid-cell tinting, hover preview). Ores placed inside asteroid body (fixed worldgen). |
